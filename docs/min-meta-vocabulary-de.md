...
**Import:** MIN v3.3.0 (`https://w3id.org/min/3.3.0`)  
...
- `min:Typus min:rationale "MIN v3.2 konnte einzelne Bestimmungen aussprechen, aber nicht sagen: Das ist ein DC04. Die Wesensbestimmung hatte keine ontologische Heimat."@de .`
...
**Beispiele:**
- `min:hasInput min:axiomRationale "Range ist min:Entity (nicht nur min:Object), weil Prozesse sowohl physische Objekte als auch Daten konsumieren können. Die frühere Einschränkung auf min:Object wurde in v3.0.0 korrigiert, da sie FEM-Simulationen nicht abbilden konnte."@de .`
...
MIN v3.2 konnte einzelne Bestimmungen aussprechen (Norma: Rm ≥ 270 MPa; Structura: bcc-Gitter), aber nicht sagen: „Das ist ein DC04." Die Wesensbestimmung hatte keine ontologische Heimat. Workarounds waren unzureichend: OWL-Klasse (hat Klassen FÜR Typen, aber keinen Begriff VON Typus), SKOS-Konzept (klassifiziert ohne zu bestimmen), Norma (kodifiziert den Typus, IST nicht der Typus).

### Lebenszyklus

Definiert in Version **3.3.0**, Status **stable**.
